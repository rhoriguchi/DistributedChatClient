...
public class TomP2P implements DistributedHashTable {

    private static final Logger LOGGER = LoggerFactory.getLogger(TomP2P.class);
    ...
    public TomP2P(int port, int maxActionWaitTime) {
        this.port = port;
